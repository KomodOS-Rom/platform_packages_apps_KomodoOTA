...
import com.komodoota.MainActivity;
import com.komodoota.R;
import com.komodoota.configs.AppConfig;
import com.komodoota.configs.OTAConfig;
import com.komodoota.configs.OTAVersion;
import com.komodoota.dialogs.WaitDialogHandler;
import com.komodoota.utils.OTAUtils;
import com.komodoota.xml.OTADevice;
import com.komodoota.xml.OTAParser;
...
public class CheckUpdateTask extends AsyncTask<Void, Void, OTADevice> {
    ...
    private void showNotification(Context context, OTADevice device) {
        if (mIsBackgroundThread) {
            ...
            int notifyID = 1;
            String id = "komodoota_channel";
            CharSequence name = context.getString(R.string.komodoota_channel);
            String description = context.getString(R.string.komodoota_channel_description);
            int importance = NotificationManager.IMPORTANCE_LOW;
            NotificationChannel mChannel = new NotificationChannel(id, name, importance);
            mChannel.setDescription(description);
            notificationManager.createNotificationChannel(mChannel);

            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context.getApplicationContext(), "KomodoOTA")
                    .setSmallIcon(R.drawable.ic_notification_komodoota)
