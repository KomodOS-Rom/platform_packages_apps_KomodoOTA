...
package com.komodoota.fragments;
...
import com.komodoota.R;
import com.komodoota.configs.AppConfig;
import com.komodoota.configs.MagiskConfig;
import com.komodoota.dialogs.CreditsDialog;
import com.komodoota.dialogs.Downloader;
import com.komodoota.dialogs.WaitDialogFragment;
import com.komodoota.tasks.CheckUpdateTask;
import com.komodoota.tasks.InitiateFlashTask;
import com.komodoota.tasks.MagiskDownloadTask;
import com.komodoota.utils.OTAUtils;
import com.komodoota.xml.OTADevice;
...
public class Fragment_OTA extends Fragment implements WaitDialogFragment.OTADialogListener, Downloader.DownloaderCallback, CheckUpdateTask.UpdateCheckerCallback {
    ...
    private void assignEvents(){
        ...
        final String donateURL = OTAUtils.getProp("ro.komodo.donate");
    ...
    private void getROMDetails(){
        currentVersion.setText(OTAUtils.getProp("ro.komodo.version"));
        rom_version.setText(getString(R.string.komodo_version, Build.VERSION.RELEASE));
        build_type.setText(OTAUtils.getProp("ro.komodo.type"));
        device_name.setText(getString(R.string.device_name, OTAUtils.getProp("ro.product.model"), OTAUtils.getProp("ro.komodo.device")));
        String maintainer_name=OTAUtils.getProp("ro.komodo.maintainer");
