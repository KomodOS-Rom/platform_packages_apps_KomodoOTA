 ...
 */
package org.komodo.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.komodo.build.version";
    public static final String PROP_DEVICE = "ro.komodo.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.komodo.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "komodo.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "komodo.updater.uri";
